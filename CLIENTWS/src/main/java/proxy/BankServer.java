 ...
 * 
 */
@WebService(name = "BankServer", targetNamespace = "http://ws/")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface BankServer {
    ...
    @Action(input = "http://ws/BankServer/listeComptesRequest", output = "http://ws/BankServer/listeComptesResponse")
    ...
    @Action(input = "http://ws/BankServer/ConversionEuroToDirhamRequest", output = "http://ws/BankServer/ConversionEuroToDirhamResponse")
    ...
    @Action(input = "http://ws/BankServer/getCompteRequest", output = "http://ws/BankServer/getCompteResponse")
